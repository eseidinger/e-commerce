package com.ecommerce.auth.jsf;
...
import com.ecommerce.auth.OpenIdConfigBean;
...
public class CallbackServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    Response tokenResponse =
        client
            .target(openIdConfigBean.getTokenUrl())
    ...
    try (JsonReader reader = Json.createReader(new StringReader(tokenJson))) {
      ...
      String refreshToken =
          json.containsKey("refresh_token") ? json.getString("refresh_token") : null;
    ...
    resp.sendRedirect(openIdConfigBean.getBaseUrl() + "/jsf/index.xhtml");
  }
}
